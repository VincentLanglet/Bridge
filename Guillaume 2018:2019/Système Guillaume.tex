...
\newpage
	...
	La rectification du Texas est obligatoire.
	
	\begin{tabular}{cccc|l}
	2SA & - & 3\carreau/\coeur & - &\\
	3\coeur/\pique & - & 3\pique/4\coeur && Chelemisant \coeur/\pique\ (3SA/4SA dénie le fit)\\
	\end{tabular}\\\\
...
\Chap{Ouverture majeure}
	...
	Même principe sur 1\pique, sauf l'enchère de 3\coeur, qui est une main limite, sans le fit \pique, avec 6\coeur\\
		...
		En cas d'intervention à la couleur, on jouera 2SA Truscott, le Cue-bid fitté forcing de manche
...
\newpage
	...
	\Section{Autres conventions}
		...
		\SSection{En cas d'intervention}
		En cas d'intervention par contre, on joue le Cachalot.\\
		\begin{tabular}{cccc|l}
		1\trefle & 1\coeur & X & - & 4\pique\\
		1\pique &&&& 3\pique\ sans l'arrêt \coeur\\
		1SA &&&& 3\pique\ avec l'arrêt \coeur\ OU 2\pique\ régulier \\
